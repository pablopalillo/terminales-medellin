...
<?php if ($params->get('greeting')) : ?>
	...
	<div class="login-greeting">
        ...
        <a href="<?php echo JRoute::_('index.php?option=com_users&view=profile&Itemid=160'); ?>">
        	Ver mi Perfil
        </a> 
        - 
        <a href="<?php echo JRoute::_('index.php?Itemid=150'); ?>">
			<?php echo JText::_('MOD_LOGIN_UPDATE'); ?>
		</a>
...
<form  id="login-form"  action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post">
	...
	<?php endif; ?>
		<a href="#" class="login-button login-button-a">
			<span>
				<?php echo 'com_english'==JRequest::getVar('option') ? "Login":"Ingresar"; ?>
			</span>
		</a>
