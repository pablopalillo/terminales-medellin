...
if ($intPages > 1) {
    ...
    for ($x = 0; $x < $intPages; $x++) {
        $intPage = $x + 1;
        echo "<a countRef='".$intPages."'ref='multimedia_table_".$x."'class='multimedia_paginator' href=".$x."><li>".$intPage."</li></a>";
    }
    echo "</ul></div>";
}
?>
<div align="center" class="paginator_orange">
...
//                $('.pag_next_a').attr('ref', 2);
            ...
            $('#multimedia_table_'+intPage).attr('class', 'showContentTable');
            $('#multimedia_table_'+intPage+' img:only-child').each(function(){
