...
?>
<div align="left" class="legend_green_"><div style="width:820px; float: left;"><?php echo $strGalleryName; ?></div>
            ...
            switch ($arrData[$i]->id_type){
                case 1:
                    ...
                    if($strClass == 'hiddenContent'){
                        echo "<div class='gallery-item-green'><a size='".round((filesize(JPATH_BASE."/multimedia/".$arrData[$i]->file_alias)/1000), 0)."' description='".$arrData[$i]->description."' author='".$arrData[$i]->author."' title='".$arrData[$i]->title."' href='multimedia/".$arrData[$i]->file_alias."'><img ref=".$arrData[$i]->thumb." src='' style='width:200px;' /></a></div>";
//                        echo "<div class='gallery-item'><a href='multimedia/".$arrData[$i]->file_alias."'><img ref=".$arrData[$i]->thumb." src='' style='width:200px;' /></a></div>";
                        break;
                    } 
                    echo "<div class='gallery-item-green'><a size='".round((filesize(JPATH_BASE."/multimedia/".$arrData[$i]->file_alias)/1000), 0)."' description='".$arrData[$i]->description."' author='".$arrData[$i]->author."' title='".$arrData[$i]->title."' href='multimedia/".$arrData[$i]->file_alias."'><img ref=".$arrData[$i]->thumb." src='multimedia/".$arrData[$i]->thumb."' style='width:190px; height:134px;' /></a></div>";
//                    echo "<div class='gallery-item-blu'><a href='multimedia/".$arrData[$i]->file_alias."'><img ref=".$arrData[$i]->thumb." src='multimedia/".$arrData[$i]->thumb."' style='width:190px; height:134px;' /></a></div>";
                    echo "<div class='gallery-item-title-green'>".$arrData[$i]->title."</div>";
                    echo "</div>";
                    break;
                case 2:
                    echo "<div align='center' style='float:left; margin-bottom:10px;'>";
                    echo "<div class='gallery-item-green'><div class='galery-audio-item-green'></div>";
                ...
                case 3:
                    echo "<div align='center' style='float:left; margin-bottom:10px;'>";
                    echo "<div class='gallery-video-item-green'><a size='".round((filesize(JPATH_BASE."/multimedia/".$arrData[$i]->file_alias)/1000), 0)."' description='".$arrData[$i]->description."' author='".$arrData[$i]->author."' title='".$arrData[$i]->title."' href='multimedia/".$arrData[$i]->file_alias."'><img ref='".$arrData[$i]->thumb."' src='multimedia/".$arrData[$i]->thumb."' style='width:190px; height:134px;' /></a></div>";
                    echo "<div class='gallery-item-title-green'>".$arrData[$i]->title."</div>";
                    echo "</div>";
                    break;
                case 4:
                    echo "<div align='center' style='float:left; margin-bottom:10px;'>";
                    echo "<div class='gallery-video-item-green'>";
                    include '_youtubePlayer.php';
                    echo "</div><div class='gallery-item-title-green'>".$arrData[$i]->title."</div>";
                    echo "</div>";
                    break;
            }
        }
...
include dirname(__FILE__).DS.'_paginator_green.php';
?>
