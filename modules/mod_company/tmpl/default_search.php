...
if($strLang == 'en'){
    ...
    $strOrderNameLabel = "Name";
    $strOrderOfficeLabel = "Office";
    $strOrderTerminalLabel = "Terminal";
    $strSearchLabel = "Search:";
    ...
    $strOrderNameLabel = "Nombre";
    $strOrderOfficeLabel = "Taquilla";
    $strOrderTerminalLabel = "Terminal";
        ...
        <div style="height:70px; width: 290px; float: left; border-bottom: 1px #CCC solid; border-right: 1px #CCC solid;">
            ...
            <div align="center" style="height: 30px;">
                ...
                <?php if($strOrderRequest == '') { ?>
                            <option selected="selected" value="1"><?php echo $strOrderNameLabel; ?></option>
                            <option value="2"><?php echo $strOrderOfficeLabel; ?></option>
                            <option value="3"><?php echo $strOrderTerminalLabel; ?></option>
                <?php } else { 
                            echo ($strOrderRequest == 1)?"<option selected='selected' value='1'>".$strOrderNameLabel."</option>":"<option value='1'>".$strOrderNameLabel."</option>";
                            echo ($strOrderRequest == 2)?"<option selected='selected' value='2'>".$strOrderOfficeLabel."</option>":"<option value='2'>".$strOrderOfficeLabel."</option>";
                            echo ($strOrderRequest == 3)?"<option selected='selected' value='3'>".$strOrderTerminalLabel."</option>":"<option value='3'>".$strOrderTerminalLabel."</option>";
                    } ?>
                </select>
            </div>
        </div>
