...
echo "<div><table class='contest-question-table' type='unique' ref='".$intRef."' style='height:100%'><tr><td><h3>".$objData->question."</h3></td></tr>";
foreach($arrOptions as $strOption){
    echo "<tr><td><input ref='".$objData->id."' name='".$intRef."' type='radio' value=".$strOption.">".$strOption."</td></tr>";
}
