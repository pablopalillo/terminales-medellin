...
<?php
    ...
    ?>
    <div id="new-content" style="width:100%; height: 220px; overflow: hidden; float:left;">
        <?php 
        if(!empty($arrArticleContent)){
            echo $arrArticleContent[0]->fulltext; 
         } else {
...
?>
<div style="width:100%; height: 20px; float:left; margin-top: 10px; padding-left: 20px;"><a id="read-more" style="color:#129AD6; font-weight: bold; text-decoration: none;" href="#">Leer Mas...</a></div>