...
?>
<div align="left" class="legend_blu_"><div style="width:820px; float: left;">Medellín Turism</div>
<div style="float: left; margin-top: -5px;"><img src="images/medTravel_icon.png" /></div></div>
<div class="content-wrap-blu">
    <div class="content-wrap-blu-container" style="width:865px; padding-bottom: 30px;">
        <?php if(array() != $arrData) : ?>
        <div style="width:710px; height: 53px; padding-top: 27px; padding-left: 90px; background: url('images/med_travel_header_en.png'); background-repeat: no-repeat; margin-left: 25px;">
            <div style="font-size: 18px;"><?php echo (isset($arrData[0]->menutitle)) ? $arrData[0]->menutitle : 'Turistic Guide'; ?></div>
        </div>
