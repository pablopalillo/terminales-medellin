...
require_once 'legend_orange.php';
?>
<div id="content-wrap-directory_orange">
    <div class="directory-container_orange">
<?php
...
if (isset($arrData) && count($arrData)>= 1) {
    ...
    require_once dirname(__FILE__).DS.'_tables_orange.php';
}
?>
    </div>
</div>